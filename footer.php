...
<footer class="footer pt-5">
    ...
    <div class="container-xl pb-4">
        <div class="row pb-4">
            <div class="col-sm-3 mb-2 order-1">
                <a href="<?= get_home_url() ?>"><img src="<?= get_stylesheet_directory_uri() ?>/img/ie-logo--wo.svg" alt="Inspired Earth Design" class="logo img-fluid mb-4"></a>
            </div>
            <div class="col-sm-6 col-lg-3 mb-2 order-3 order-lg-2">
                <div class="footer__title">Contact</div>
                <ul>
                    <li><a href="mailto:<?= get_field('contact_email', 'options') ?>"><?= get_field('contact_email', 'options') ?></a>
                    </li>
                    <li>Jude Yeo: <a href="tel:<?= parse_phone(get_field('contact_judith', 'options')) ?>"><?= get_field('contact_judith', 'options') ?></a>
                    </li>
                    <li>Emily Grayshaw: <a href="tel:<?= parse_phone(get_field('contact_emily', 'options')) ?>"><?= get_field('contact_emily', 'options') ?></a>
                    </li>
                </ul>
    ...
    <div class="colophon">
        <div class="container-xl">
            <div>&copy; <?= date('Y') ?> Inspired Earth Design Ltd. Registered in England, No. 13515175
            </div>
